...
ESOPs offer a way for employees to participate in the financial growth of the company apart from their regular salary. They are a tool to generate wealth and should not be miss-understood for income. They are a fare and legal means to generate wealth if the company does well.
...
### Exercise Period
Once you have some vested options, you can exercise them. The exercise period specifies the time period within which vested options must be exercised, starting from the date od vesting.
